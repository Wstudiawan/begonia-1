...
git clone --depth=1 https://github.com/Wstudiawan/DragonTC clang
git clone https://github.com/sohamxda7/llvm-stable -b gcc64 --depth=1 gcc
git clone https://github.com/sohamxda7/llvm-stable -b gcc32  --depth=1 gcc32
git clone --depth=1 https://github.com/TeraaBytee/AnyKernel3 -b master AnyKernel
echo "Done"
...
function zipping() {
    cd AnyKernel || exit 1
    zip -r9 Kelok-44 Kernel-${TANGGAL}.zip *
    cd ..
}
sticker
sendinfo
